...
function BasicTab({
  ...
  const onLatLngChang2 = (latLng: any, address: string, geoDeg: string) => {
    console.log("this is computed G", geoDeg)
    // setInputs((prevState) => ({
    //   ...prevState,
    //   latitude: latLng.lat,
    ...
    onLatLngChang(latLng, address, geoDeg);
    console.log("this is", geoDeg)
    setOpenMap(false);
  };
