...
function PlacesPopup({
  ...
  console.log("input from forms",inputs)
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      setCategory("Select");
      setAttachment(null);
      console.log("asdasdasdasd12asd", setInputs)
    };
  }, [open]);
  console.log("czzczcxzxczxc", open)
  ...
  const handleSave = async (arrImgUrl?: string[]) => {
    ...
    console.log("handlesave",selCountry )
    ...
    console.log("addding new places to collection", params)
    ...
    if (!selectedRow) {
      ...
      handleClose();
      console.log("fnsave",params)
      // console.log("casdasdasdadasdasd",newParams)
    } else {
      // 업데이트
